"""Implementations of MinkLoc3D models.
...
from opr.layers.eca import MinkECABasicBlock as ECABasicBlock
from opr.layers.gem import MinkGeM
...
class MinkLoc3D(nn.Module):
    ...
    def __init__(
        ...
        Original paper: https://arxiv.org/abs/2011.04530
