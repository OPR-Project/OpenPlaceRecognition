...
class Dataset3RScan(Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            picture_limit_per_scan (int): Number of pictures to load from each scan. Defaults to 10.
        ...
        self.dataset_df = self._generate_dataframe(scene_references, track_numbers, room_numbers)
    ...
    def _generate_dataframe(self, scene_references: Dict[str, str], track_numbers: Dict[str, int],
                            room_numbers: Dict[str, int]) -> pd.DataFrame:
        ...
        for idx in range(len(self.frame_ids)):
            ...
            track = track_numbers[self.frame_ids[idx][0]]
